...
public final class CommandManager {
	...
	private CommandManager(Persons persons) {
		CommandManager.persons = persons;
	}

	public static CommandManager getInstance(Persons persons) {
		if (instance == null) {
			commands = new ArrayList<>();
			instance = new CommandManager(persons);
		}
   ...
   */
	...
	public static String execute(Command command, Object[] args) {
		return command.execute(persons, args);
	}
